                ...
                <CurriculumContainer>
                    <CurriculumGroup>
                        <CurriculumBox>
                            ...
                            <CurriculumDetailText> - 파이썬 문법, 프로그래밍 기초 이론 수업 - 1달</CurriculumDetailText>
                            <CurriculumDetailText> - 언어모델의 원리와 파인튜닝 수업 - 2달</CurriculumDetailText>
                            <CurriculumDetailText> - OpenCV를 사용한 이미지 처리와 학습 수업 - 1달</CurriculumDetailText>
                        </CurriculumBox>
                        <CurriculumBox>
                            <CurriculumTitle>2학기</CurriculumTitle>
                            <CurriculumDetailText> - 선린에서 데이터 조사 및 수집, 정보 윤리 수업 - 1달 </CurriculumDetailText>
                            <CurriculumDetailText> - 수집한 데이터를 활용하여 머신러닝 수업 - 2달</CurriculumDetailText>
                            <CurriculumDetailText> - 딥러닝 기초 이론 수업 - 1달 </CurriculumDetailText>
                        </CurriculumBox>
                    </CurriculumGroup>
                    <CurriculumGroup>
                        <CurriculumBox>
                            <CurriculumTitle>여름방학</CurriculumTitle>
                            <CurriculumDetailText> - 파이썬 백엔드 프레임워크를 사용한 REST API 특강</CurriculumDetailText>
                            <CurriculumDetailText> - 파이썬을 이용한 자유 연구 프로젝트</CurriculumDetailText>
                        </CurriculumBox>
                        <CurriculumBox>
